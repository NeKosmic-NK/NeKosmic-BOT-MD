...
let str = `
*ミ💖 𝙷𝙾𝙻𝙰 ✨${name}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 𝙳𝙴 𝚃𝙷𝙴 𝙽𝚎𝙺𝚘𝚜𝚖𝚒𝚌 - 𝙱𝙾𝚃 💖彡*
*📅 𝙵𝙴𝙲𝙷𝙰: ${week}, ${date}*
...
° ඬ⃟🧧 _${usedPrefix}copybutton *<texto>*_
*<𝔼𝔽𝔼ℂ𝕋𝕆𝕊 𝕐 𝕃𝕆𝔾𝕆𝕊/>*
...
`.trim()
conn.sendHydrated2(m.chat, str, wm, pp, 'https://vm.tiktok.com/ZMNaeWvpb/', '✨𝚃𝚒𝚔𝚃𝚘𝚔✨', 'https://www.instagram.com/invites/contact/?i=tol351ueuxke&utm_content=ohvhscn', '👑𝙸𝙽𝚂𝚃𝙰𝙶𝚁𝙰𝙼👑', [
['📮 𝙳𝙾𝙽𝙰𝚁 📮', '/donasi'],
['🌹 𝙶𝚁𝚄𝙿𝙾𝚂 🌹', '/gruposofc'],
